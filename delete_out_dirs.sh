...
mkdir -p ./pcap/output/{1-PCAP-export,2-stats/graphs/,3-JSON-export/box-plots/,4-ML/{{preprocess,inference_results}/{labeled_files,labeled_data,data_ready_to_ml},models/training_results}}
echo "[ OK ]"
